# Sidebar — Changes & Reusable Guide (CoreUI Angular)
...
- **Expanded**: dark gradient sidebar, rounded nav pills, glowing active item with a left accent rail,
  **brand shows the full wordmark** ("OLS DASHBOARD" + tagline).
...
/* Brand tile: white rounded square holding the logo image. */
.ols-brand__mark {
