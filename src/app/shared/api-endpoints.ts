...
export const API = {
  ...
  regression: {
    ...
    releaseDates: `${API_BASE_URL}/api/regression/release/dates`,
    releaseScripts: `${API_BASE_URL}/api/regression/release/scripts`,
    batchDBScripts: `${API_BASE_URL}/api/regression/batch-db-scripts`,
    ...
    fileCopyManifests: `${API_BASE_URL}/api/regression/file-copy/manifests`,
