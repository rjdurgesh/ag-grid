...
CREATE TABLE ols_app_access (
  ...
  resource_scope VARCHAR2(64)  NOT NULL,                            -- log_analytics | config_ops:group|cib|retail | service_console | oracle_command_center
  resource_key   VARCHAR2(128) DEFAULT '*' NOT NULL,               -- server_name | table_name | category | section-key | '*' (all in scope)
  ...
  CONSTRAINT ols_app_access_ck_type  CHECK (resource_type IN ('SCREEN','SERVER','TABLE_CATEGORY','TABLE','SECTION')),
...
INSERT INTO ols_app_access (username, resource_type, resource_scope, resource_key, access_level, app_env, granted_by, comments)
VALUES ('DBAUSER','SCREEN','oracle_command_center','*','WRITE','PROD','ADMIN1','can kill sessions / apply fixes');
INSERT INTO ols_app_access (username, resource_type, resource_scope, resource_key, access_level, app_env, granted_by, comments)
